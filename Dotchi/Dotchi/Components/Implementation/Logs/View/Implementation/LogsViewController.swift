...
extension LogsViewController {
    ...
    private func initializeCollectionView() {
        ...
        dataSource = UICollectionViewDiffableDataSource<LogsCollectionView.Section, Log>(
            collectionView: collectionView) { (collectionView, indexPath, log) -> UICollectionViewCell in
            // swiftlint:disable force_cast
            let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: LogCell.identifier,
    ...
    private func createCollectionSectionLayout(for section: LogsCollectionView.Section) -> NSCollectionLayoutSection {
        ...
        case .main:
            ...
            item.edgeSpacing = NSCollectionLayoutEdgeSpacing(
                leading: nil,
                top: NSCollectionLayoutSpacing.fixed(cellMargin),
                trailing: nil,
                bottom: NSCollectionLayoutSpacing.fixed(cellMargin))
            ...
            section.contentInsets = NSDirectionalEdgeInsets(
                ...
                leading: collectionViewHorizontalInset,
                bottom: collectionViewHorizontalInset,
                trailing: collectionViewHorizontalInset)
            return section
        }
    }
}
